...
class Configuration
{
    ...
    {
        $config = \GuzzleHttp\json_decode(file_get_contents(realpath(__DIR__  . '/../setting/config.json')), true);

        $this->apiKey = $config['apiKey'];
        $this->apiSID = $config['appSID'];
        $this->host = $config['basePath'];
    ...
    {
        $report  = 'PHP SDK (Client\Invoker) Debug Report:' . PHP_EOL;

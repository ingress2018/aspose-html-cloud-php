...
class TranslationApi
{
     ...
     * @return \SplFileObject
     */
    public function translationPutTranslateDocument($name, $src_lang, $res_lang, $storage = null, $folder = null)
    {
        list($response) = $this->translationPutTranslateDocumentWithHttpInfo($name, $src_lang, $res_lang, $storage, $folder);
        return $response;
    }
     ...
     * @return array of \SplFileObject, HTTP status code, HTTP response headers (array of strings)
     */
    public function translationPutTranslateDocumentWithHttpInfo($name, $src_lang, $res_lang, $storage = null, $folder = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->translationPutTranslateDocumentRequest($name, $src_lang, $res_lang, $storage, $folder);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function translationPutTranslateDocumentAsync($name, $src_lang, $res_lang, $storage = null, $folder = null)
    {
        return $this->translationPutTranslateDocumentAsyncWithHttpInfo($name, $src_lang, $res_lang, $storage, $folder)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function translationPutTranslateDocumentAsyncWithHttpInfo($name, $src_lang, $res_lang, $storage = null, $folder = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->translationPutTranslateDocumentRequest($name, $src_lang, $res_lang, $storage, $folder);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function translationPutTranslateDocumentRequest($name, $src_lang, $res_lang, $storage = null, $folder = null)
    {
        // verify the required parameter 'name' is set
        if ($name === null) {
            throw new \InvalidArgumentException(
